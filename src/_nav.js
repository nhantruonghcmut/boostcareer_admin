...
const _nav = [
  ...
  },
  {
    ...
    to: '/manage_job',
    icon: <i className="bi bi-briefcase nav-icon"></i>//<CIcon icon={cilBriefcase} customClassName="nav-icon" />,
    // items: [
    //   {
    //     component: CNavItem,
    //     name: 'Buttons',
  ...
  },
  {
    ...
    to: '/manage_candidate',
    icon: <i className="bi bi-people nav-icon"></i>//<CIcon icon={cilPeople} customClassName="nav-icon" />,
    // items: [
    //   {
    //     component: CNavItem,
    //     name: 'Form Control',
  ...
  },
  {
    ...
    to: '/manage_employer',
    icon:  <i className="bi bi-buildings nav-icon"></i>//<CIcon icon={cilChartPie} customClassName="nav-icon" />,
  },
  {
    component: CNavItem, //CNavGroup,
    name: 'Sao lưu và khôi phục',
    to: '/manage_backup',
    icon: <i className="bi bi-floppy nav-icon"></i>//<CIcon icon={cilSave} customClassName="nav-icon" />,
    // items: [
    //   {
    //     component: CNavItem,
    //     name: 'CoreUI Free',
  ...
  },
  {
    ...
    name: 'Báo cáo',
    to: '/report',
    icon: <i className="bi bi-bar-chart nav-icon"></i>,//<CIcon icon={cilBell} customClassName="nav-icon" />,
    // items: [
    //   {
    //     component: CNavItem,
    //     name: 'Alerts',
